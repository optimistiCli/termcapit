...
[ "$(id -u)" -lt 1000 ] && echo 'Should run as pedestrian user, NOT as root' && exit 1
sudo -v || exit 1
...
TST_DIR="$(mktemp -p /tmp -d ${0##*/}_${TESTED##*/}.XXXXXXXXXX)"
...
TST_SOURCE="$(sudo -n mktemp -p /tmp ${0##*/}_${TESTED##*/}.XXXXXXXXXX)"
...
TST_DIR="$(sudo -n mktemp -p /tmp -d ${0##*/}_${TESTED##*/}.XXXXXXXXXX)"
...
TST_SOURCE="$(mktemp -p /tmp ${0##*/}_${TESTED##*/}.XXXXXXXXXX)"
rm "$TST_SOURCE"
